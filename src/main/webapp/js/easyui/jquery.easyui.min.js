...
if(col.field){
td.attr("field",col.field);
if(col.title && col.title.indexOf("redStar")>-1){
td.append("<div class=\"datagrid-cell datagrid-cell-redStar\"><span></span><span class=\"datagrid-sort-icon\"></span></div>");	
}else{	
